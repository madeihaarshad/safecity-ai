...
const WelcomeModal = () => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm animate-fadeIn">
      <div className="bg-[var(--surface)] rounded-xl border border-[var(--border)] shadow-2xl w-full max-w-md mx-4 overflow-hidden animate-slideUp">
        {/* Header with icon */}
        <div className="relative bg-[var(--card)] p-8 text-center border-b border-[var(--border)]">
        ...
        <div className="p-6">
          ...
          <div className="flex items-center justify-center gap-3">
            <button
              onClick={handleClose}
              className="px-4 py-2 text-sm text-[var(--subtle)] hover:text-[var(--text)] transition-colors"
            >
              Skip
            </button>
            <button
              onClick={handleNext}
              className="flex items-center gap-2 px-6 py-2.5 bg-[var(--accent)] hover:bg-[var(--accent-dark)] text-[var(--bg)] font-bold rounded-lg transition-all accent-glow"
            >
          ...
          {/* Step counter */}
          <p className="text-center text-xs text-[var(--subtle)] mt-4">
