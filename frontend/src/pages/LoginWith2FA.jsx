...
import { Truck, Shield, AlertCircle, Eye, EyeOff, Key, ShieldCheck, ArrowLeft } from 'lucide-react';
...
const LoginWith2FA = () => {
  ...
  const [step, setStep] = useState('login'); // login, verify2fa
  ...
  // Original login form (same as before)
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-[var(--bg)] to-[var(--surface)]">
      <div className="max-w-md w-full bg-[var(--surface)] rounded-2xl shadow-2xl border border-[var(--border)] p-8">
        {/* Logo */}
        ...
        <form onSubmit={handleInitialLogin} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-[var(--accent)] hover:bg-[var(--accent)]/80 text-white font-semibold py-2 rounded-lg disabled:opacity-50"
          >
